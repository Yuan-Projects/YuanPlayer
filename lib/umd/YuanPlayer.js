(function (global, factory) {
  ...
  class PlayList extends Emitter {
      constructor(options) {
          ...
          this.list = [];
          this.modeIndex = 0;
          this.trackItemId = 0; // auto increment index, TODO: a robust id
          this.container = options.container;
      ...
      processList(list) {
          const returnList = list.map(item => {
              return Object.assign(Object.assign({}, item), { id: typeof item.id === 'undefined' ? this.trackItemId++ : item.id });
          });
          return returnList;
      }
      shuffle() {
      ...
      add(trackItem) {
          var _a;
          const item = Object.assign(Object.assign({}, trackItem), { id: (_a = trackItem.id) !== null && _a !== void 0 ? _a : this.trackItemId++ });
