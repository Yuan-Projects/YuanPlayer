          ...
          setTimeout(() => {
              this.on('shuffledchanged', () => {
                  ...
                  if (this.shuffled) {
                      ...
                      (_a = document.querySelector(this.player.cssSelectorAncestor)) === null || _a === void 0 ? void 0 : _a.classList.add(this.stateClass.shuffled);
                  }
                  else {
                      this.container.classList.remove(this.stateClass.shuffled);
                      (_b = document.querySelector(this.player.cssSelectorAncestor)) === null || _b === void 0 ? void 0 : _b.classList.remove(this.stateClass.shuffled);
                  }
              });
              this.on('modechange', () => {
                  // TODO
